...
if __name__ == "__main__":
    base_dir = "./FlowLearn/SimFlowchart/images/mermaid_word/jpeg"
    output_json = "test_FlowLearn_mermaid_word.json" 

    png_paths = collect_png_images(base_dir)
    json_data = build_json_data(png_paths)
    save_json(json_data, output_json)

    print(f"[✓] saved {len(json_data)} records to {output_json}")
