...
img_dir = './Block-Diagram-Datasets/Handwritten_block_diagrams/FC_B/test'
output_json_path = './Block-Diagram-Datasets/Handwritten_block_diagrams/FC_B/test_FC_B_base_model.json'
